{
  ...
  "share_snapshot:create_snapshot": "rule:context_is_editor",
  "share_snapshot:delete_snapshot": "rule:context_is_editor",
  "share_snapshot:get_snapshot": "rule:context_is_viewer",
  "share_snapshot:get_all_snapshots": "rule:context_is_viewer",
  "share_snapshot:snapshot_update": "rule:context_is_editor",
