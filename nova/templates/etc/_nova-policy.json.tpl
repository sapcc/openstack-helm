{
    ...
    "compute_extension:admin_actions:lock": "rule:context_is_editor",
    "compute_extension:admin_actions:unlock": "rule:context_is_editor",
    ...
    "os_compute_api:os-lock-server:lock": "rule:context_is_editor",
    "os_compute_api:os-lock-server:unlock": "rule:context_is_editor",
