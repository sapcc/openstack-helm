...
CACHES = {
    'default': {
        ...
        'LOCATION': '{{include "memcached_host" .}}:{{.Values.global.memcached_port_public}}',
    }
}
...
OPENSTACK_HOST = "{{include "keystone_api_endpoint_host_internal" .}}"
OPENSTACK_KEYSTONE_URL = "{{.Values.global.keystone_api_endpoint_protocol_internal}}://{{include "keystone_api_endpoint_host_internal" .}}:{{.Values.global.keystone_api_port_internal}}"
